...
#if NGV_DMU_SYSCLK == SYSCLK_IRC_16MHZ || NGV_DMU_SYSCLK == SYSCLK_PLL_64MHZ
...
#elif NGV_DMU_SYSCLK == SYSCLK_PLL_32MHZ || NGV_DMU_SYSCLK == SYSCLK_PLL_64MHZ    
