...
/*----------------------------------------------------------- */
    ...
    LINFLEX_0.LINIBRR.R = 0x0011;
        /* Baudrate : 115107.91 Symbols/sec */
        /* Integer Baud Rate Factor: 17*/
...
/*----------------------------------------------------------- */
    ...
    LINFLEX_1.LINIBRR.R = 0x0008;
        ...
        /* Integer Baud Rate Factor: 8*/
#elif NGV_DMU_SYSCLK == SYSCLK_PLL_32MHZ
    LINFLEX_1.LINIBRR.R = 0x0011;
        /* Baudrate : 115107.91 Symbols/sec */
        /* Integer Baud Rate Factor: 17*/
#elif NGV_DMU_SYSCLK == SYSCLK_PLL_64MHZ
    LINFLEX_1.LINIBRR.R = 0x0022;
        /* Baudrate : 115107.91 Symbols/sec */
        /* Integer Baud Rate Factor: 34*/
#endif
...
/*----------------------------------------------------------- */
    ...
    LINFLEX_1.LINFBRR.R = 0x000B;
        /* Fractional Baud Rate Factor: 11*/
#elif NGV_DMU_SYSCLK == SYSCLK_PLL_32MHZ
    LINFLEX_1.LINFBRR.R = 0x0006;
        /* Fractional Baud Rate Factor: 6*/
#elif NGV_DMU_SYSCLK == SYSCLK_PLL_64MHZ
    LINFLEX_1.LINFBRR.R = 0x000C;
        /* Fractional Baud Rate Factor: 12*/
#endif
...
/*----------------------------------------------------------- */
    ...
    LINFLEX_2.LINIBRR.R = 0x0008;
        ...
        /* Integer Baud Rate Factor: 8*/
#elif NGV_DMU_SYSCLK == SYSCLK_PLL_32MHZ
    LINFLEX_2.LINIBRR.R = 0x0011;
        /* Baudrate : 115107.91 Symbols/sec */
        /* Integer Baud Rate Factor: 17*/
#elif NGV_DMU_SYSCLK == SYSCLK_PLL_64MHZ
    LINFLEX_2.LINIBRR.R = 0x0022;
        /* Baudrate : 115107.91 Symbols/sec */
        /* Integer Baud Rate Factor: 34*/
#endif
...
/*----------------------------------------------------------- */
    ...
    LINFLEX_2.LINFBRR.R = 0x000B;
        /* Fractional Baud Rate Factor: 11*/
#elif NGV_DMU_SYSCLK == SYSCLK_PLL_32MHZ
    LINFLEX_2.LINFBRR.R = 0x0006;
        /* Fractional Baud Rate Factor: 6*/
#elif NGV_DMU_SYSCLK == SYSCLK_PLL_64MHZ
    LINFLEX_2.LINFBRR.R = 0x000C;
        /* Fractional Baud Rate Factor: 12*/
#endif
