...
INTCInterruptFn INTCInterruptsHandlerTable[INTC_INTERRUPTS_REQUEST_VECTOR_TABLE_SIZE] = {
	...
	interrupt_handler,    /* Vector - 43    interrupt_handler*/
	...
	interrupt_handler,    /* Vector - 60    interrupt_handler*/
	interrupt_handler,    /* Vector - 61    interrupt_handler*/
	interrupt_handler,    /* Vector - 62    interrupt_handler*/
	interrupt_handler,    /* Vector - 63    Reserved */
	interrupt_handler,    /* Vector - 64    interrupt_handler*/
	...
	interrupt_handler,    /* Vector - 79    interrupt_handler*/
	interrupt_handler,    /* Vector - 80    interrupt_handler*/
	...
	interrupt_handler,    /* Vector - 99    interrupt_handler*/
	interrupt_handler,    /* Vector - 100    interrupt_handler*/
	...
	interrupt_handler,    /* Vector - 119    interrupt_handler*/
	interrupt_handler,    /* Vector - 120    interrupt_handler*/
	...
	interrupt_handler,    /* Vector - 127    interrupt_handler*/
	...
	interrupt_handler,    /* Vector - 162    interrupt_handler*/
	interrupt_handler,    /* Vector - 163    interrupt_handler*/
	interrupt_handler,    /* Vector - 164    interrupt_handler*/
