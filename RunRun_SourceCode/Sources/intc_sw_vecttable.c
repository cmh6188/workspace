...
uint32_t IntcIsrVectorTable[] = {
    ...
    (uint32_t)&sonarInt0,    /* Vector - 41    sonarInt0*/
    ...
    (uint32_t)&angleControlPIT,    /* Vector - 59    angleControlPIT*/
    (uint32_t)&sonarDelay0,    /* Vector - 60    sonarDelay0*/
    (uint32_t)&speedControlPIT,    /* Vector - 61    speedControlPIT*/
