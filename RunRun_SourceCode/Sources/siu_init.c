...
void siu_portB_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[22].R = 0x2000;
             /*	Selected Function : ADC_0_ADC_1_ANP2          */
             /*	Output Buffers : Disabled         */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[23].R = 0x2000;
             /*	Selected Function : ADC_0_ADC_1_ANP3          */
             /*	Output Buffers : Disabled         */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
...
void siu_portG_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[100].R = 0x0201;
             /*	Selected Function : PG4 O          */
             /*	Output Buffers : Enabled          */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[101].R = 0x0201;
             /*	Selected Function : PG5 O          */
             /*	Output Buffers : Enabled          */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
...
void siu_general_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
        SIU.IRER.R = 0x00000001;
             /* Edge Trigger External Interrupt 0 Enable :-Enabled */
...
/*-----------------------------------------------------------*/
               SIU.PSMI[7].R = 0x00;
                /*Function Pad Selected DSPI1_SCK :- PCR34*/
...
/*-----------------------------------------------------------*/
               SIU.PSMI[9].R = 0x00;
                /*Function Pad Selected DSPI1_CS :- PCR35*/
...
/*-----------------------------------------------------------*/
               SIU.PSMI[25].R = 0x02;
                /*Function Pad Selected eMIOS0_CH24 :- PCR75*/
