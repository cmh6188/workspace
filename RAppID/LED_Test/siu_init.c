...
void siu_portH_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[112].R = 0x0101;
             /* User Assigned Signal Name : PH0_DSPI_DATA_IN  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[113].R = 0x0A01;
             /* User Assigned Signal Name : PH1_DSPI_DATA_OUT  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[114].R = 0x0A01;
             /* User Assigned Signal Name : PH2_DSPI_CLK_OUT  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[115].R = 0x0A01;
             /* User Assigned Signal Name : PH3_DSPI_CS0_OUT  */
